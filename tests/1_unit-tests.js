...
suite('Unit Tests', () => {
    test('Translate  Mangoes are my favorite fruit. to British English', (done) => {
      ...
      test('Translate I ate yogurt for breakfast. to British English', (done) => {
        assert.equal(translator.americanToBritish('I ate yogurt for breakfast.'), 'I ate <span class="highlight">yoghurt</span> for <span class="highlight">brekkie</span>.');
        done();
      });
      ...
      test('Translate Like a high tech Rube Goldberg machine. to British English', (done) => {
        assert.equal(translator.americanToBritish('Like a high tech Rube Goldberg machine.'), 'Like a high tech Rube Goldberg machine.');
        done();
      });
      ...
      test('Translate Paracetamol takes up to an hour to work. to American English', (done) => {
        assert.equal(translator.britishToAmerican('Paracetamol takes up to an hour to work.'), '<span class="highlight">Acetaminophen</span> takes up to an hour to work.');
        done();
      });
